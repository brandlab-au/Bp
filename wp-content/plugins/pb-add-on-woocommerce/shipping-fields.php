...
function wppb_woo_get_shipping_fields(){
    return array(
        'shipping_country' => array( 'label' => __('Country','profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'shipping_first_name' => array( 'label' => __('First Name','profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'shipping_last_name'=> array( 'label' => __('Last Name','profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'shipping_company' => array( 'label' => __('Company Name','profile-builder-woocommerce-add-on'), 'required' => 'No'),
        'shipping_address_1' => array( 'label' => __('Address','profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'shipping_address_2' => array( 'label' => '', 'required' => 'No'),
        'shipping_city' => array( 'label' => __('Town / City','profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'shipping_state' => array( 'label' => __('State / County','profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'shipping_postcode' => array( 'label' => __('Postcode / Zip','profile-builder-woocommerce-add-on'), 'required' => 'Yes')
    );
}
