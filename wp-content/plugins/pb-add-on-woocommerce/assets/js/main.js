...
function WooCheckoutFields() {
    ...
    var checkoutFields = ['Default - First Name', 'Default - Last Name', 'Default - Nickname', 'Default - Biographical Info', 'Input', 'Textarea', 'Checkbox', 'Select' , 'Radio', 'Heading', 'Datepicker', 'Phone', 'Number', 'Avatar', 'Upload', 'MailChimp Subscribe' ];
