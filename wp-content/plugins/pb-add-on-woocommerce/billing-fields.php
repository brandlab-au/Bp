...
function wppb_woo_get_billing_fields(){
    return array(
        'billing_country' => array('label' => __('Country', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_first_name' => array('label' => __('First Name', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_last_name' => array('label' => __('Last Name', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_company' => array('label' => __('Company Name', 'profile-builder-woocommerce-add-on'), 'required' => 'No'),
        'billing_address_1' => array('label' => __('Address', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_address_2' => array('label' => '', 'required' => 'No'),
        'billing_city' => array('label' => __('Town / City', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_state' => array('label' => __('State / County', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_postcode' => array('label' => __('Postcode / Zip', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_email' => array('label' => __('Email Address', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes'),
        'billing_phone' => array('label' => __('Phone', 'profile-builder-woocommerce-add-on'), 'required' => 'Yes')
    );
}
        ...
        if ( ($form_location == 'register') && $in_manage_fields ) {
            ?><script type="text/javascript">
                jQuery(document).ready(function(){
                    jQuery("#woo_different_shipping_address").click(function(){
                        ...
                        jQuery(".wppb-woocommerce-customer-shipping-address input" ).trigger( "wppbToggleRequiredAttributeEvent" );
                    });
                });
            </script> <?php
            $checked = 'checked';
            ...
            $different_address_checkbox = '
                    <ul>
                        ...
                        <strong>'. __('Ship to a different address?','profile-builder-woocommerce-add-on').'</strong> </label>
                        </li>
                    </ul>';
