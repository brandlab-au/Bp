...
function admin_notice() {
	...
	public function register_backup_database_pages( $pages ){
		...
		$pages['page']['backup_database_manage'] = array(
			'title' 	=> 'Manage Backup',
			'path'		=> BACKUP_DATABASE_ABSPATH . '/pages/manage.php',
			'class' 	=> 'fa fa-tasks fa-1x',
			'slug'		=> 'backup_database_manage',
			'permission'=> 'administrator',
			'call'		=> 'backup_database_manage_ui'
			);
