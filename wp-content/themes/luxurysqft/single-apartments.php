							...
							<div class="thanks-lightbox">
								...
								<div class="data-info">
									<div class="logo-holder">
										<picture>
											<!--											<img src="-->
											<?php //print get_user_meta( $author_id, 'company_logo' )[0];
						...
						<?php if ( get_field( 'method' ) == 'buy' ) { ?>
							<?php if ( $product->is_in_stock() ) : ?>
								...
								<form class="cart" method="post" enctype='multipart/form-data'>
									...
									<button type="submit"
											class="single_add_to_cart_button btn btn-default"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
						...
						<?php } else { ?>
							<a href="#" class="btn btn-default" data-toggle="modal"
							   data-target="#myModal3">
								<?php _e( 'CONTACT BROKER', 'luxurysqft' ); ?>
							</a>
						<?php } ?>
