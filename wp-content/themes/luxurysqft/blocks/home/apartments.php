<?php if ( $apartments = get_field( 'featured_selection' ) ) :
	global $saved_ids ?>
	<!-- products list -->
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 text-center">
					<h2><?php _e( 'Featured selection', 'luxurysqft' ); ?></h2>
				</div>
				<div class="clearfix"></div>
				<?php foreach ( $apartments as $key => $post ) :
					setup_postdata( $post );
					$saved = is_array( $saved_ids ) && in_array( get_the_ID(), $saved_ids ) ? 'saved' : ''; ?>
					<div class="col-xs-12 col-sm-4 apartment-block">
