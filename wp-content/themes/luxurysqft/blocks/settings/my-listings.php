<div id="tab1_4">
	<div class="tab-block page-heading text-center">
		...
		<div class="heading">
			...
			<span class="link"><?php _e( 'LISTINGS', 'luxurysqft' ); ?></span>
		</div>
	...
	<div class="tab-description">
		<ul class="links">
			<li>
				<a href="<?php echo add_query_arg( 'post_type', 'apartments', admin_url( 'post-new.php' ) ) ?>"><?php _e( 'Add Listings', 'luxurysqft' ); ?></a>
			</li>
		</ul>
		<?php $edit_url = wp_nonce_url( get_permalink( get_the_ID() ), 'edit_post_from_listings', 'edit_apartment' );
		...
		if ( $query->have_posts() ) :
			global $saved_ids; ?>
			<ul class="apartments-list listings-block edit-list" data-src="<?php echo admin_url( 'admin-ajax.php' ) ?>">
				<?php $i = 0;
							...
							<div class="drop-block">
								<div class="holder">
									<ul class="btn-list">
										...
										<li><a href="#"
										       class="prime"><?php _e( 'MAKE THIS PRIME', 'luxurysqft' ); ?></a></li>
										...
										<?php endif; ?>
										<li><a class="remove open"
										       href="#"><?php _e( 'REMOVE PROPERTY', 'luxurysqft' ); ?></a></li>
									</ul>
								</div>
							</div>
						</div>
